...
class Swg(object):
    ...
    def scale(self):
        ...
        SWG_Data.set_axis(["UPPER_BUS_PHASE_A","UPPER_BUS_PHASE_B","UPPER_BUS_PHASE_C","LOWER_BUS_PHASE_A","LOWER_BUS_PHASE_B","LOWER_BUS_PHASE_C","OUTGOING_PHASE_A","OUTGOING_PHASE_B","OUTGOING_PHASE_C","UPPER_BUS_PD", "LOWER_BUS_PD", "SPOUT_PD", "OUTGOING_PD"], axis='columns', inplace=True) 
